...
class BroadcastMessageTask extends Task {
    ...
    private static $message = [
        "§l§a»» §r§fJoin our official §9Discord §fat §adiscord.gg/JkmgXF4Q4C §f!",
        "§l§a»» §r§fBuy a rank for access to exlusive features, cosmetics or unban at §asega.tebex.io §f!"];
